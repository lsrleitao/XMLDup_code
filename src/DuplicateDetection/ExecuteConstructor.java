...
public class ExecuteConstructor {
    ...
    private boolean _ISORIGINALSTRUCTURE = true;
    private String _OriginalConfigFile = "./XMLDup Data/DBConfigFile/config_restaurants.xml";
    private String _configFile = "./XMLDup Data/DBConfigFile/config_restaurants_classified_edited.xml";
    private String _dbPath = "./XMLDup Data/DB";
    
    public ExecuteConstructor(String dbPath, String configPath){
        this._dbPath = dbPath;
        this._OriginalConfigFile = configPath;
    }
